...
if not st.session_state.role:
    ...
    with center_col:
        st.markdown("<h1 style='text-align: center;'>🔐 CloudCV Internal Operations Chatbot</h1>", unsafe_allow_html=True)
        with st.form("login"):
...
# --- CHAT INTERFACE ---
    ...
    # Main Chat Area
    st.title("💬 CloudCV Knowledge Assistant")
